//In this program we have to find out index of an given input number and store all
//the indexes in an given 
//If the number is not present in the array then simply return 0
//example array=[5,5,6,6,5] the element is 5
//output array2=[0,1,3]
